...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
         ...
         <!-- Card de Aviso de Sell-Out -->
         <div class="mt-4 card shadow-sm border-info">
                <div class="card-body">
                    <h5 class="card-title text-info">
                        <i class="fas fa-info-circle"></i> Em Desenvolvimento
                    </h5>
                    <p class="card-text">
                        Em breve, teremos uma ferramenta de apontamento de sell-out para que os clientes possam nos enviar seus registros de venda. Fique atento às atualizações!
                    </p>
                </div>
            </div>
        </div>
